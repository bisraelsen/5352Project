...
graph_draw(g,vertex_fill_color=state.get_blocks(), output=dirname+ "/" + gName.strip(".xml.gz") + ".pdf")
graph_draw(g,vertex_fill_color=state.get_blocks(), output=dirname+ "/" + gName.strip(".xml.gz") + ".png")
