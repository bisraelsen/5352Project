...
MDL
\centering
\includegraphics[width=\linewidth]{../MDL/serengeti-foodweb/serengeti-foodweb.png}
$K=18$
...
Bayes
\centering
\includegraphics[width=\linewidth]{../Bayes/serengeti-foodweb/serengeti-foodweb.png}
$K=39$
\end{minipage}
\vspace{10pt}
