...
\includegraphics[width=\linewidth]{pgp.png}

\includegraphics[width=\linewidth]{Bayes/footba/figure.png}
...
\includegraphics[width=\linewidth]{ER_n_1000_k_5_0.png}
...
\input{include/adjnoun.tex}

\subsection*{Bow-tie}
\input{include/bowtie.tex}

\subsection*{Dolphins}
\input{include/dolphins.tex}

\subsection*{Les Mis\'{e}rables}
\input{include/lesmis.tex}

\subsection*{Football}
\input{include/football.tex}

\subsection*{Zachary Karate Club}
\input{include/karate.tex}

\subsection*{Political Books}
\input{include/polbooks.tex}

\subsection*{Serengeti Foodweb}
\input{include/serengeti-foodweb.tex}
